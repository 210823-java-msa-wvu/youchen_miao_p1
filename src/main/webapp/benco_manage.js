let baseUrl = "http://localhost:8080/Project1/benco";
...
function viewAllExceed(){
    ...
    //open the request
    xhr.open("put","http://localhost:8080/Project1/benco/exceed");
    //sent the request
    xhr.send();
...
function viewAll(){
    ...
    xhr.onreadystatechange = receiveData;
    //open the request
    xhr.open("get","http://localhost:8080/Project1/benco");
    //sent the request
    xhr.send();
...
function loadManager(){
    ...
    xhr.onreadystatechange = receiveData;
    //open the request
    xhr.open("get","http://localhost:8080/Project1/manager_manage");
    //sent the request
    xhr.send();
